...
const countryData: Record<CountrySlug, CountryData> = {
  peru: {
    ...
    seo: {
      landingTitle: 'Bruno Mars en Perú 2027 | The Romantic Tour — Estadio Monumental Lima',
      landingDescription: 'Bruno Mars llega a Perú con The Romantic Tour 2027. Viernes 12 de Septiembre en el Estadio Monumental de Lima. Más de 2 horas de espectáculo con todos los hits.',
      ticketsTitle: 'Entradas Bruno Mars Perú 2027 | Estadio Monumental Lima — The Romantic Tour',
      ticketsDescription: 'Compra entradas para Bruno Mars en Perú. The Romantic Tour 2027 en el Estadio Monumental de Lima. Viernes 12 de Septiembre. Zonas disponibles desde S/ 250.',
  ...
  chile: {
    ...
    seo: {
      landingTitle: 'Bruno Mars en Chile 2027 | The Romantic Tour — Estadio Nacional Santiago',
      landingDescription: 'Bruno Mars llega a Chile con The Romantic Tour 2027. Martes 16 de Septiembre en el Estadio Nacional de Santiago. Más de 2 horas de espectáculo con todos los hits.',
      ticketsTitle: 'Entradas Bruno Mars Chile 2027 | Estadio Nacional Santiago — The Romantic Tour',
      ticketsDescription: 'Compra entradas para Bruno Mars en Chile. The Romantic Tour 2027 en el Estadio Nacional de Santiago. Martes 16 de Septiembre. Zonas disponibles desde $45.000.',
  ...
  argentina: {
    ...
    seo: {
      landingTitle: 'Bruno Mars en Argentina 2027 | The Romantic Tour — Estadio Monumental Buenos Aires',
      landingDescription: 'Bruno Mars llega a Argentina con The Romantic Tour 2027. Sábado 20 de Septiembre en el Estadio Monumental de Buenos Aires. Más de 2 horas de espectáculo con todos los hits.',
      ticketsTitle: 'Entradas Bruno Mars Argentina 2027 | Estadio Monumental Buenos Aires — The Romantic Tour',
      ticketsDescription: 'Compra entradas para Bruno Mars en Argentina. The Romantic Tour 2027 en el Estadio Monumental de Buenos Aires. Sábado 20 de Septiembre. Zonas disponibles desde $85.000.',
  ...
  colombia: {
    ...
    seo: {
      landingTitle: 'Bruno Mars en Colombia 2027 | The Romantic Tour — Estadio El Campín Bogotá',
      landingDescription: 'Bruno Mars llega a Colombia con The Romantic Tour 2027. Miércoles 24 de Septiembre en el Estadio El Campín de Bogotá. Más de 2 horas de espectáculo con todos los hits.',
      ticketsTitle: 'Entradas Bruno Mars Colombia 2027 | Estadio El Campín Bogotá — The Romantic Tour',
      ticketsDescription: 'Compra entradas para Bruno Mars en Colombia. The Romantic Tour 2027 en el Estadio El Campín de Bogotá. Miércoles 24 de Septiembre. Zonas disponibles desde $450.000.',
  ...
  brasil: {
    ...
    seo: {
      landingTitle: 'Bruno Mars no Brasil 2027 | The Romantic Tour — Allianz Parque São Paulo',
      landingDescription: 'Bruno Mars chega ao Brasil com The Romantic Tour 2027. Domingo, 28 de Setembro no Allianz Parque em São Paulo. Mais de 2 horas de espetáculo com todos os sucessos.',
      ticketsTitle: 'Ingressos Bruno Mars Brasil 2027 | Allianz Parque São Paulo — The Romantic Tour',
      ticketsDescription: 'Compre ingressos para Bruno Mars no Brasil. The Romantic Tour 2027 no Allianz Parque em São Paulo. Domingo, 28 de Setembro. Setores disponíveis a partir de R$ 350.',
