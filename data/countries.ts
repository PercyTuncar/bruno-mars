...
const countryData: Record<CountrySlug, CountryData> = {
  peru: {
    ...
    seo: {
      ...
      ticketsDescription: 'Compra tus entradas oficiales para Bruno Mars en Perú. The Romantic Tour, 12 de Septiembre de 2027, Estadio Monumental. Elige tu zona: Occidente, Oriente, Cancha o Tribuna Norte.',
  ...
  chile: {
    ...
    seo: {
      ...
      ticketsDescription: 'Compra tus entradas oficiales para Bruno Mars en Chile. The Romantic Tour, 16 de Septiembre de 2027, Estadio Nacional. Elige tu zona: Occidente, Oriente, Cancha o Tribuna Norte.',
  ...
  argentina: {
    ...
    seo: {
      ...
      ticketsDescription: 'Compra tus entradas oficiales para Bruno Mars en Argentina. The Romantic Tour, 20 de Septiembre de 2027, Estadio Monumental. Elige tu zona: Occidente, Oriente, Cancha o Tribuna Norte.',
  ...
  colombia: {
    ...
    seo: {
      ...
      ticketsDescription: 'Compra tus entradas oficiales para Bruno Mars en Colombia. The Romantic Tour, 24 de Septiembre de 2027, Estadio El Campín. Elige tu zona: Occidente, Oriente, Cancha o Tribuna Norte.',
  ...
  brasil: {
    ...
    seo: {
      ...
      ticketsDescription: 'Compre seus ingressos oficiais para Bruno Mars no Brasil. The Romantic Tour, 28 de Setembro de 2027, Allianz Parque. Escolha seu setor: Oeste, Leste, Campo ou Tribuna Norte.',
